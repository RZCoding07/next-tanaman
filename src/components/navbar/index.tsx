  ...
  return (
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        ...
        >
          {darkmode ? (
            <RiSunFill className="h-4 w-4 text-gray-600 dark:text-yellow-500" />
          ) : (
          ...
          <div className="flex h-32 w-56 flex-col justify-start rounded-[20px] bg-white bg-cover bg-no-repeat shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none">
            ...
            <div className="ml-4 mt-3 flex flex-col">
              <NavLink href="/admin/profile">
                <p className="text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white">
                  Profile
                </p>
              </NavLink>
              <a
