...
const GrafikKuadran = () => {
    ...
    useEffect(() => {
        ...
        if (chartRef.current) {
            ...
            const data = [
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN A', 'Manajer A'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN B', 'Manajer B'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN C', 'Manajer C'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN D', 'Manajer D'] },
                // Continue for other data points
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN E', 'Manajer E'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN F', 'Manajer F'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN G', 'Manajer G'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN H', 'Manajer H'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN I', 'Manajer I'] },
                // Continue for other data points
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN J', 'Manajer J'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN K', 'Manajer K'] },
                // Continue for other data points
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN M', 'Manajer M'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN N', 'Manajer N'] },
                // Continue for other data points
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN P', 'Manajer P'] },
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN R', 'Manajer R'] },
                // Continue for other data points
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN T', 'Manajer T'] },
                // Continue for other data points
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN V', 'Manajer V'] },
                // Continue for other data points
                { value: [getRandomNumber(1, 4), getRandomNumber(2000, 3000), 'KEBUN X', 'Manajer X'] },
                // Continue for other data points
