...
const UploadIplFile: React.FC = (): JSX.Element => {
    ...
    const handleUploadKuadran = async (): Promise<void> => {
    ...
    return (
        <div>
            ...
            >
                <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer" htmlFor="fileInput" onClick={handleFileChange}>
